...
def build_widget():
 ...
 page=_page(Adw,PLUG); group=_group(Adw,page,"Input devices"); text=_read("~/.config/hypr/input.conf").strip()
 added = False
 if text:
 ...
 _disabled(Gtk, Adw, group,"Input configuration"); return page
