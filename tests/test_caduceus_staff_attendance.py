...
_staff_spec = _importlib_util.spec_from_file_location("agathodaimon.admin_admittance.staff_daemon_face", ROOT / "agathodaimon/admin-admittance/staff-daemon/index.py")
...
class AttendanceTests(unittest.TestCase):
    ...
    def test_service_daemon_is_seated_in_service_band(self):
        self.assertTrue((ROOT / "agathodaimon" / "admin-admittance" / "staff-daemon" / "index.py").is_file())
