...
#
# Usage: agathodaimon/portals/calibre/calibreHelperDaemon.sh [COMMAND] [COMPONENT]
...
User=root
Group=root
ExecStart=/usr/local/sbin/agathodaimon/portals/calibre/calibreHelperDaemon.sh feeder-cron
...
sync_now() {
    ...
    log_info "Check status with: agathodaimon/portals/calibre/calibreHelperDaemon.sh status"
}
