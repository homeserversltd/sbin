...
SCHEMA="caduceus.nas.sync.v1"; MODULE="agathodaimon.backup.nas_sync"; BASH="/usr/bin/bash"; SAFE_SYNC="/usr/local/sbin/safe-nas-sync.sh"; SYSTEMCTL="/usr/bin/systemctl"; RM="/usr/bin/rm"; UNIT_DIR="/etc/systemd/system"; SERVICE="agathodaimon-nas-sync.service"; TIMER="agathodaimon-nas-sync.timer"
