...
def update_portals(config_url: str) -> dict:
    ...
    if shown["exit"] != 0: raise RuntimeError("agathodaimon-config-unreachable")
    try:
        ...
        raise RuntimeError("agathodaimon-config-unreachable")
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="agathodaimon-matrix-converge")
