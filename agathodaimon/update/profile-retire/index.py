...
def main(argv:Sequence[str]|None=None)->int:
    p=argparse.ArgumentParser(prog="agathodaimon-rebis-profile-retire"); p.add_argument("--plan",action="store_true"); a=p.parse_args(argv); value=retire(a.plan); print(json.dumps(value,sort_keys=True)); return 0 if value['ok'] else 1
